...
import '../cubit/friend_setup_cubit.dart';
import '../widget/custom_drop_down.dart';
import '../widget/friend_setup_form.dart';
...
class _FriendSetupViewState extends State<FriendSetupView> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => FriendSetupCubit(),
      child: BlocBuilder<FriendSetupCubit, FriendSetupState>(
        builder: (context, state) {
          final cubit = context.read<FriendSetupCubit>();
